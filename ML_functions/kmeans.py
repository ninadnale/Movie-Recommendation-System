...
movies = pd.read_csv('/home/ninad/workspace/movie_rcm/hello_world/movies.csv')
#movies.head()
...
def draw_movie_clusters(clustered, max_users, max_movies):
    ...
    for cluster_id in range(3):
        ...
        if len(d) > 9:
            ...
            plt.savefig("/home/ninad/workspace/movie_rcm/media/"+str(cluster_id)+".png", bbox_inches='tight')
...
def draw_movies_heatmap(most_rated_movies_users_selection, axis_labels=True):
    ...
    plt.savefig("/home/ninad/workspace/movie_rcm/media/heatmap.png", bbox_inches='tight')
...
ratings = pd.read_csv('/home/ninad/workspace/movie_rcm/hello_world/ratings.csv')
#ratings.head()
